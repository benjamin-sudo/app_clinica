<?php
    ...
    if(count($DATA["ALL_CIRUGIAS"][0])>0){
        ...
        $VAR_IDENTIFICADOR_PAC          =   $DATA["P_ANATOMIA_PATOLOGICA_MAIN"][0]['RUTPACIENTE'];
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <body>
        <h2 style="margin: 0px 0px 0px 0px;color:#e34f49;"><b>SOLICITUD CITOLOG&Iacute;A</b></h2>
        ...
        <table tabindex="2" width="100%" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:8px;"> 
            <tbody>
                <tr>
                    <td colspan="4" class="subtitulo_formulario2"  bgcolor="#ECF1F1">&nbsp;<b>DETALLE SOLICITUD:</b></td>
                </tr>
                <tr>
                        ...
                        <thead>
                            <tr>
                                ...
                                <td class="border_bottom_left" width="50%" valign="top">
                                    ...
                                    <label><font size=2>ML:</font></label><br>     
                                    <b><?php echo $row_muestras["NUM_ML"]==0?'0&nbsp;':$row_muestras["NUM_ML"]; ?></b><br>
                                    ...
                                    <table width="100%" style="margin: 0px 0px 0px -1px;">
                                        <tbody>
                                            <tr>
                                                <td style="width: 50%">
                                                    <p style="margin: -4px 0px -3px -3px;">
                                                        ...
                                                        <b class="size_9"><?php echo $VAR_ANATOMIA_PATALOGICA; ?></b>
                                                    </p>
                                                </td>
                                                <td style="width: 50%">
                                                    <p style="margin: -4px 0px -3px -3px;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p style="margin: -4px 0px -3px -3px;">
                                                        <label class="size_9">ML</label><br>    
                                                        <b class="size_9"><?php echo $row_muestras["NUM_ML"]==0?'0&nbsp;':$row_muestras["NUM_ML"]; ?></b>
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
