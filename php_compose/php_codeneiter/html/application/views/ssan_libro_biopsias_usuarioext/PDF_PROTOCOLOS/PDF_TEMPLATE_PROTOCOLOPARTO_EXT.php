        ...
        foreach($listaRRHH as $i => $hhrr) {
            if ($hhrr['ID_FUNCION_PB'] == '0') {
                if ($hhrr['ID_TIPO_RRHH'] == 1) {
                    ...
                    $nomCitu2               = "" . $hhrr['TXTNOMBRE'];
                } else if ($hhrr['ID_TIPO_RRHH'] == 3) {
                    $nomCitu3               = "" . $hhrr['TXTNOMBRE'];
                } else if ($hhrr['ID_TIPO_RRHH'] == 4) {
                    $nomAnes                = $hhrr['TXTNOMBRE'];
                } else if ($hhrr['ID_TIPO_RRHH'] == 6) {
                    $enfermeros             .="<li>".$hhrr['TXTNOMBRE']."</li>";
                } else if ($hhrr['ID_TIPO_RRHH'] == 7) {
                    $matrones               .="<li>".$hhrr['TXTNOMBRE']."</li>";
                } else if ($hhrr['ID_TIPO_RRHH'] == 8) {
                       $pediatras           .="<li>".$hhrr['TXTNOMBRE']."</li>";
                } else if ($hhrr['ID_TIPO_RRHH'] == 9) {
                    $equipo_trabajo         .="<li>".$hhrr['TXTNOMBRE']."</li>";
                }
            } else {
            
                        if ($hhrr['ID_FUNCION_PB'] == 1) {
                    $auxiliar_anestesia     .="<li>".$hhrr['TXTNOMBRE']."</li>";
                } else if ($hhrr['ID_FUNCION_PB'] == 2) {
                    $arsenalera             .="<li>".$hhrr['TXTNOMBRE']."</li>";
                } else if ($hhrr['ID_FUNCION_PB'] == 3) {
                    $pabellonera            .="<li>".$hhrr['TXTNOMBRE']."</li>";
                } else if ($hhrr['ID_FUNCION_PB'] == 4) {
                    $TNS_PARTO              .="<li>".$hhrr['TXTNOMBRE']."</li>";
                } else if ($hhrr['ID_FUNCION_PB'] == 5) {
                    $TNS_RNI                .="<li>".$hhrr['TXTNOMBRE']."</li>";
                }
            ...
            <tr>
                <td width="35%" valign="top">
                    ...
                    <table width="100%" style="margin-top:0px;">
                        ...
                        <tr>
                            <td width="100%"><h5>&#8226;&nbsp;TIEMPOS DE PABELL&Oacute;N<small></small></h5></td>
                        </tr>
                        <tr width="100%">
                            <td width="100%">
                                <li>&nbsp;INICIO CIRUGIA                            : <b><?php echo $tablaop['FECHAHORASOLICITUD']; ?></b></li>
                                <li>&nbsp;FINAL CIRUGIA                             : <b><?php echo $tablaop['FECHAHORAFINAL']; ?></b></li>    
                            </td>    
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="table table-sm subtitulo_formulario2" style="width:100%;border: none;margin-bottom: 5px;"> 
                    <thead>
                        ...
                        <tr class="subtitulo_formulario2">
                            ...
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><!--<b>TERCER CIRUJANO</b>--></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" ><?php echo $nomCitu2;?></td>
