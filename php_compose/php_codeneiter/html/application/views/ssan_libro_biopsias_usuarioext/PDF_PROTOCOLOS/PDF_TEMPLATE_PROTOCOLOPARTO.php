        ...
        foreach($listaRRHH as $i => $hhrr) {
            if ($hhrr['ID_FUNCION_PB'] == '0'){
                if ($hhrr['ID_TIPO_RRHH'] == 1) {
                    $PrimerCirujano                 =   "" . $hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>';
                    $RUN_CIRUJANO                   =   $hhrr['RUT_COMPLETO'];
                } else if ($hhrr['ID_TIPO_RRHH']    == 2) {
                    $nomCitu2                       = "" . $hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>';
                } else if ($hhrr['ID_TIPO_RRHH']    == 3) {
                    $nomCitu3                       = "" . $hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>';
                } else if ($hhrr['ID_TIPO_RRHH']    == 4) {
                    $nomAnes                        = $hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>';
                } else if ($hhrr['ID_TIPO_RRHH']    == 6) {
                    $enfermeros                     .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                } else if ($hhrr['ID_TIPO_RRHH']    == 7) {
                    $matrones                       .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                } else if ($hhrr['ID_TIPO_RRHH']    == 8) {
                    $pediatras                      .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                } else if ($hhrr['ID_TIPO_RRHH']    == 9) {
                    $equipo_trabajo                 .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                } 
            } else if ($hhrr['ID_TIPO_RRHH'] == 10){
                    $ayudante_parto                 .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
            } else if ($hhrr['ID_TIPO_RRHH'] == 11){
                    $TNS_PARTO                      .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
            } else if ($hhrr['ID_TIPO_RRHH'] == 12){
                    $TNS_RNI                        .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
            } else {
                        if ($hhrr['ID_FUNCION_PB']  == 1) {
                    $auxiliar_anestesia             .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                } else  if ($hhrr['ID_FUNCION_PB']  == 2) {
                    $arsenalera                     .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                } else  if ($hhrr['ID_FUNCION_PB']  == 3) {
                    $pabellonera                    .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                //} else  if ($hhrr['ID_FUNCION_PB']  == 4) {
                //  $TNS_PARTO                      .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                //} else  if ($hhrr['ID_FUNCION_PB']  == 5) {
                //    $TNS_RNI                        .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                //} else  if ($hhrr['ID_FUNCION_PB']  == 11) {
                 //   $TNS_PARTO                      .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
               // } else  if ($hhrr['ID_FUNCION_PB']  == 12) {
                 //   $TNS_RNI                        .="<li>".$hhrr['TXTNOMBRE'].'&nbsp;&nbsp;<font size=1><b>'.$hhrr['RUT_COMPLETO'].'</b></font>'."</li>";
                }
            }
        }
...
if($matrones            =='') {   $matrones             ="<li>NO INFORMADO</li>";   }               
if($pediatras           =='') {   $pediatras            ="<li>NO INFORMADO</li>";   }     
if($enfermeros          =='') {   $enfermeros           ="<li>NO INFORMADO</li>";   }    
if($auxiliar_anestesia  =='') {   $auxiliar_anestesia   ="<li>NO INFORMADO</li>";   }     
if($arsenalera          =='') {   $arsenalera           ="<li>NO INFORMADO</li>";   }     
if($pabellonera         =='') {   $pabellonera          ="<li>NO INFORMADO</li>";   }  
if($TNS_PARTO           =='') {   $TNS_PARTO            ="<li>NO INFORMADO</li>";   }     
if($TNS_RNI             =='') {   $TNS_RNI              ="<li>NO INFORMADO</li>";   }
//*****************************RECURSO HUMANO****************
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>REPORTE PROTOCOLO DE PARTO</title>
    ...
    <body>
            ...
            <tr>
                ...
                <td width="94%" style="width:89%;text-align:right">
                    ...
                    <address>
                        ...
                        TIPO DE CIRUG&Iacute;A                      : <b><?php echo "PROTOCOLO DE PARTO";?></b><br><!--$tablaop['TIPO_OP']-->
        ...
        <table width="100%" class="table_2"> 
            <tr>
                <td width="35%" valign="top">
                    ...
                    <table width="100%" style="margin-top: 5px;">
                        <tbody>
                            <tr>
                                <td width="100%"><h5>&#8226;&nbsp;DIAGNOSTICO PRE-PARTO<small></small></h5></td>
                            </tr>
                            <tr>
                                <td width="100%">&nbsp;<?php echo $tablaop['TXTDIAGNOSTICO']==""?"NO INFORMADO":$tablaop['TXTDIAGNOSTICO'];?></td> 
                            </tr>
                            <tr>
                                <td width="100%"><h5>&#8226;&nbsp;DIAGNOSTICO POST-PARTO<small></small></h5></td>
                            </tr>
                            <tr>
                                <td width="100%">&nbsp;<?php echo $tablaop['TXTDIAGNOPOST'];?></td>
                            </tr>
                            <tr>
                                <td width="100%"><h5>&#8226;&nbsp;CIRUG&Iacute;A REALIZADA&nbsp;<small>(<?php echo count($DATA["COD_MAI"]);?>)</small></h5></td>
                            </tr>
                            <tr>
                                <td width="100%">
                                    <?php 
                            ...
                            <tr>
                                <td width="100%"><h5>&#8226;&nbsp;DIAGNOSTICOS CIE-10<small></small></h5></td>
                            </tr>
                            <tr>
                                <td width="100%">
                                <?php
                                    if(count($DATA["P_ALL_LISTACIE10"])>0){
                                        foreach ($DATA["P_ALL_LISTACIE10"] as $i => $row){
                                            echo '<li><b>('.$row["COD_DIAGNO_CIE"].')</b> - '.$row["TXT_DESCIPCIONCIE10"].'</li>';
                                        }
                                    } else {
                                        echo "<li>SIN INFORMACI&Oacute;N</li>";
                                    }
                            ...
                            <tr>
                                <td width="100%"><h5 style="margin: 0px 0px 0px 0px;">&#8226;&nbsp;ANESTESIAS<small></small></h5></td>
                            </tr>
                            <tr>
                                <td width="100%">
                                <?php
                                    if(count($DATA["ALL_ANESTESIAS"])>0){
                                        echo "<ul>";
                                        foreach ($DATA["ALL_ANESTESIAS"] as $i => $row){
                                            echo '<li style="margin: 0px 0px 0px 0px;">'.$row["NOM"].'</li>';
                                        }
                                        echo "</ul>";
                                    } else {
                                        echo "<li>SIN ANESTESIAS</li>";
                                    }
                                ?>
                                </td>
                            </tr>
                    ...
                    <table width="100%" style="margin-top:0px;">
                        <tbody>
                        <tr>
                            <td width="100%" style="margin-top: -110px;"><h5>&#8226;&nbsp;INFORMACI&Oacute;N QUIR&Uacute;RGICA<small></small></h5></td>
                        </tr>
                        <tr width="100%">
                            <td width="100%">
                                <li>&nbsp;PABELL&Oacute;N                               : <b><?php echo $tablaop['SALA_DESCRIPCION']; ?></b></li>   
                                <li>&nbsp;ALUMNO                                        : <b><?php echo $tablaop['TXTINFOALUMNO']; ?></b></li>
                                <?php if($tablaop['TXTINFOALUMNO']!='NO'){?>
                                <li>&nbsp;NOM ALUMNO                                    : <b><?php echo $tablaop['TXT_ALUMNO']; ?></b></li>
                                <?php } ?>
                                <li>&nbsp;PROFILAXIS ANTIBI&Oacute;TICA ANTEPARTO       : <b><?php echo $tablaop['PROFILAXIS']; ?></b></li>
                                <li>&nbsp;BIOPSIA                                       : <b><?php echo $tablaop['BIOPSIA']; ?></b></li>
                                <li>&nbsp;TIPO DE HERIDAS                               : <b><?php echo $tablaop['HERIDAS']; ?></b></li> 
                                <li>&nbsp;CULTIVOS                                      : <b><?php echo $tablaop['CULTIVOS']; ?></b></li>
                                <li>&nbsp;DERIVACI&Oacute;N                             : <b><?php echo $tablaop['DERIVACION']; ?></b></li>
                                <!-- hito 04-03-2021 -->
                                <li>&nbsp;EPISIOTOM&Iacute;A                            : <b><?php echo $tablaop['PAR_IND_EPISIOTOMIA']; ?></b></li> 
                                <li>&nbsp;DESGARRO                                      : <b><?php echo $tablaop['PAR_IND_DESGARROS']; ?></b></li>
                                <li>&nbsp;PARTO ACOMPA&Ntilde;ADO                       : <b><?php echo $tablaop['PAR_PARTOACOMPANADO']; ?></b></li>
                                <!--   
                                <li>&nbsp;EPISIOTOM&Iacute;A                            : <b><?php echo $tablaop['IND_PAR_EPISIOTOMIA']; ?></b></li>
                                <li>&nbsp;DESGARRO                                      : <b><?php echo $tablaop['IND_PAR_DESGARRO']; ?></b></li>
                                <li>&nbsp;ACOMPA&Ntilde;AMIENTO                         : <b><?php echo $tablaop['IND_MAIN_ACOPANANTE']; ?></b></li>
                                <?php if($tablaop['IND_MAIN_ACOPANANTE']!='NO'){?>
                                <li>&nbsp;ACOMPA&Ntilde;ANTE                            : <b><?php echo $tablaop['IND_TIPO_ACOMPANANTE']; ?></b></li>
                                <?php } ?>
                                -->
                                <!--
                                <li>&nbsp;EMBARAZO CONTROLADO                           : <b><?php echo $tablaop['IND_EMBARAZO_CONTROLADO']; ?></b></li>
                                <li>&nbsp;TIPO OP                                       : <b><?php echo $tablaop['IND_TIPO_EMBARAZO']; ?></b></li>
                                <li>&nbsp;MEMBRANAS ROTAS                               : <b><?php echo $tablaop['IND_MEMBRANA_ROTA']; ?></b></li>
                                <li>&nbsp;EMBARAZO CONTROLADO                           : <b><?php echo $tablaop['IND_EMBARAZO_CONTROLADO']; ?></b></li>
                                -->
                            </td>
                        </tr>
                        <tr>
                            <td width="100%"><h5>&#8226;&nbsp;TIEMPOS DE SALA DE PARTO<small></small></h5></td>
                        </tr>
                        <tr width="100%">
                            <td width="100%">
                                <li>&nbsp;FECHA/HORA INICIO PARTO                       : <b><?php echo $tablaop['FECHAHORASOLICITUD']; ?></b></li>
                                <li>&nbsp;FECHA/HORA FINAL PARTO                        : <b><?php echo $tablaop['FECHAHORAFINAL']; ?></b></li>    
                            </td>    
                        </tr>
                    </tbody>
                </table>
            ...
            <td width="65%" valign=top>
                <h5>&#8226;&nbsp;RRHH DEL PARTO<small></small></h5>
                <table class="table table-sm subtitulo_formulario2" style="width:100%;border: none;margin-bottom: 5px;"> 
                    <thead>
                        <tr class="subtitulo_formulario2">
                            <td width="50%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>PROFESIONAL QUE ATIENDE EL PARTO</b></td>
                            <td width="50%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>ANESTESISTA</b></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" ><?php echo $PrimerCirujano;?></td>
                            <td class="subtitulo_formulario2" ><?php echo $nomAnes;?></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>PROFESIONAL QUE ASISTE</b></td>
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>SEGUNDO PROFESIONAL QUE ASISTE</b></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" >SEGUNDO PROFESIONAL QUE ASISTE</td>
                            <td class="subtitulo_formulario2" ><?php echo $nomCitu3;?></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>PEDIATRAS</b></td>
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>MATRONA/O</b></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" ><?php echo $pediatras;?></td>
                            <td class="subtitulo_formulario2" ><?php echo $matrones;?></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>ENFERMEROS</b></td>
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>AUX DE ANESTESIA</b></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" ><?php echo $enfermeros;?></td>
                            <td class="subtitulo_formulario2" ><?php echo $auxiliar_anestesia;?></td>
                        </tr>
                        <!--
                        <tr class="subtitulo_formulario2" >
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>PABELLONERA</b></td>
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>ARSENALERA</b></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" >&nbsp;<?php echo $pabellonera;?></td>
                            <td class="subtitulo_formulario2" >&nbsp;<?php echo $arsenalera;?></td>
                        </tr>
                        -->
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>TNS PARTO</b></td>
                            <td class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>TNS RNI</b></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td class="subtitulo_formulario2" ><?php echo $TNS_PARTO;?></td>
                            <td class="subtitulo_formulario2" ><?php echo $TNS_RNI;?></td>
                        </tr>
                    </thead>    
                </table>

                <!--
                <h5>&#8226;&nbsp;DESCRIPCI&Oacute;N ATENCI&Oacute;N DE PARTO <small></small></h5>

                <table class="table table-sm subtitulo_formulario2" style="width:100%;border: none;"> 
                    <thead>
                        <tr class="subtitulo_formulario2">
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>PACIENTE EN POSICI&Oacute;N</b></td>
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>EPISIOTOM&Iacute;A</b></td>
                            <td width="34%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>SUTURA POR PLANOS</b></td>
                        </tr>
                        <tr>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['IND_PACIENTE_POSICION']; ?> </td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['IND_EPISIOTOMIA']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['TXT_SUTURA_X_PLANOS']; ?></td>
                        </tr>

                        <tr class="subtitulo_formulario2">
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>L&Iacute;QUIDO AMNI&Oacute;TICO</b></td>
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>DESGARROS</b></td>
                            <td width="34%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>DESCRIPCION DESGARROS</b></td>
                        </tr>

                        <tr>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['IND_LIQUIDO_AMNIOTICO']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['IND_DESGARROS']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['TXT_DESGARROS']; ?></td>
                        </tr>

                        <tr class="subtitulo_formulario2">
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>SUTURAS A USAR</b></td>
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>ALUMBRAMIENTO</b></td>
                            <td width="34%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b style="font-size: 8px;">REVISION DE INSTRUMENTAL</b></td>
                        </tr>
                        <tr>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['TXT_SUTURA']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['IND_ALUMBRAMIENTO']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['IND_REV_INSTUMENTAL']; ?></td>
                        </tr>


                        <tr class="subtitulo_formulario2">
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>PESO PLACENTA</b></td>
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>LONGITUD CORDON RN</b></td>
                            <td width="34%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>RETRACTOR UTERINO</b></td>
                        </tr>
                        <tr>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['NUM_PESO_PLACENTA']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['NUM_LONGITUD_CONDON']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['IND_RETRACTOR_UTERINO']; ?></td>
                        </tr>
                        <tr class="subtitulo_formulario2">
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>RETRACTOR UTERINO </b></td><!--¡cual?-->
                <!--
                            <td width="33%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ><b>DURACIÓN DEL EXPULSIVO</b></td>
                            <td width="34%" class="subtitulo_formulario2" bgcolor="#ECF1F1" ></td>
                        </tr>
                        <tr>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['TXT_RETRACTOR_UTERINO']; ?></td>
                            <td class="subtitulo_formulario2" ><?php echo $tablaop['MIN_EXTRACION_FETAL']; ?></td>
                ...
                -->
                <h5>&#8226;&nbsp;DESCRIPCI&Oacute;N DEL PARTO</h5>
