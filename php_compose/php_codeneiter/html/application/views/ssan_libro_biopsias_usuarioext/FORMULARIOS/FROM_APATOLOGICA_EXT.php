        ...
        <div id="TABS_ANATOMIA_PATOLOGICA" style="width:100%;min-height:<?php echo $CALL_FROM==1?'770px':'600px';?>;padding:<?php echo $CALL_FROM==2?'0px':'4px';?> 4px 4px 4px;">
            ...
            <ul class="nav nav-tabs " role="tablist">
                <li role="presentation" class="active" >
                    <a href="#TABS_MAIN_ANATOMIA" aria-controls="TABS_MAIN_ANATOMIA" role="tab" id="0" data-toggle="tab" style="text-align:start;"> 
        ...
        <?php  
            ...
            ?>
                <li role="presentation" >
                    <a href="#TABS_ETIQUETAS_ANATOMIA" aria-controls="TABS_ETIQUETAS_ANATOMIA" role="tab" id="1" data-toggle="tab" style="text-align:start;">
                        <i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;M. ANATOMIA</b>
                    </a>
                </li>
        <?php } ?>
        <?php
            ...
            ?>  
                <li role="presentation">
                    <a href="#TABS_ETIQUETAS_CITOLOGIA" aria-controls="TABS_ETIQUETAS_CITOLOGIA" role="tab" id="2" data-toggle="tab" style="text-align:start;">
                        <i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;M. CITOLOG&Iacute;A&nbsp;<?php echo $IND_TIPO_BIOPSIA == '6' ? 'PAP' : '' ?>
                    </a>
                </li>
        <?php } ?>  
            </ul>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="TABS_MAIN_ANATOMIA">
                ...
                <?php if($IND_TIPO_BIOPSIA == '2' || $IND_TIPO_BIOPSIA == '3'  || $IND_TIPO_BIOPSIA == '4' || $IND_TIPO_BIOPSIA == '6' ){ ?>    
                        <div role="tabpanel" class="tab-pane" id="TABS_ETIQUETAS_ANATOMIA" style="margin:<?php echo $CALL_FROM==5?'-18px':'-18px'?> 0px -25px 0px;">
            ...
            if ($IND_TIPO_BIOPSIA == '4' || $IND_TIPO_BIOPSIA == '5'){ ?>
                   <div role="tabpanel" class="tab-pane" id="TABS_ETIQUETAS_CITOLOGIA" style="margin:<?php echo $CALL_FROM==5?'-18px':'-18px'?> 0px -25px 0px;">
                            <table class="table table-striped" style="width:100%;margin-bottom:0px;">
                                <thead>
                                    <tr>
