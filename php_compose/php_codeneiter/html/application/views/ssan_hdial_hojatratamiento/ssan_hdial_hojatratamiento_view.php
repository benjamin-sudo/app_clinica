<div class="grid_body_cabecera">
    ...
    <div class="grid_body_cabecera2" style="text-align: -webkit-right;">
        <button type="button" class="btn btn-danger btn-fill" id="BTN_UPDATE_PANEL_2" onclick="test_ws()" style="display: none">WS</button>
...
<div class="grid_heard_hoja_tratamiento">
            ...
            <div class="content">
                <div class="contenedor">
                    <div class="form-group">
                        <div class="input-group date" id="datetimepicker1" style="width:142px;">
                            <input type="text" class="form-control input-sm" value="<?php echo (date("d-m-Y"))?>" id="numFecha" name="numFecha"/>
    ...
    <div class="grid_heard_hoja_tratamiento2">
        <div class="card" style="margin-bottom: 0px">
            ...
            <div class="content">
                <div class="contenedor">
                    <div class="form-group">
                        <select id="num_Maquina" name="num_Maquina" class="form-control input-sm" style="width: 300px" onchange="eventosBuscar(this.value)"></select>
                    </div>
                    <br>
                </div>
            </div>
    ...
    <div class="grid_heard_hoja_tratamiento3">
        <div class="card" id="card_fecha_especial" style="display:none;margin-bottom:0px">
            <div class="header">
                <h4 class="title"><b>FECHA ESPECIAL</b></h4>
                <p class="category"></p>
            </div>
            <div class="content">
                <div class="contenedor">
                ...
                <div class="header">
                    <div class="grid_panel_hojasdiarias">
                        <div class="grid_panel_hojasdiarias1">
                            <h4 class="title"><b class="plomo">HOJA/S DIARIAS DISPONIBLES</b></h4>
                        </div>
