                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input style="width: 90px;" type="time" class="form-control input-sm" id="hrs_star_sala_proceso" name="hrs_star_sala_proceso" maxlength="5" size="5"  value="<?php echo $data_bd[":P_SALA_PROCESO"][0]["TIME_HORA"];?>">
                                </td>
                            </tr>
                        </table>
                    </div>
