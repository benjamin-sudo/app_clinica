...
<table style="width:100%">
    <tr>
        ...
        <td style="width:35%" valign="top">
            <b>SERVICIO DE SALUD ARAUCANIA NORTE</b>
            <br>
            <b><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['TXT_HOSPDERIVADO'];?></b>
            <br>
            <b>CENTRO RECEPCI&Oacute;N - ANATOM&Iacute;A PATOL&Oacute;GICA</b>
            <br>
            <?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['COD_EMPRESA'] == '100'?'<b>BLO/VRR</b>':'';?>
        </td>
        <td style="width:20%;text-align: center" valign="top">&nbsp;<b>RECEPCI&Oacute;N DE MUESTRAS ANATOM&Iacute;A PATOL&Oacute;GICA</b></td>
        <td style="width:35%;" valign="top" >
            <p>
                <?php  
                ...
                <?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['IND_TIPO_BIOPSIA'] == 4?'<br>':'';?> 
...
<?php
    $date_trasporte         =   new DateTime(date('d-m-Y h:i:s',strtotime($DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['FECHA_TRASLADO']." ".$DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['HORA_TRASLADO'].":00")));
    $date_recepcion         =   new DateTime(date('d-m-Y h:i:s',strtotime($DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['FECHA_RECEPCION']." ".$DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['HORA_RECEPCION'].":00")));
    $diff                   =   $date_recepcion->diff($date_trasporte); 
    $num_dias               =   $diff->days;
    $num_hora               =   $diff->h;
    $num_minutos            =   $diff->i;
?>
<table style="width:100%;" class="border">
    <tr>
        <td colspan="4" style="background-color:#9b9b9b;height:40px;">
            &nbsp;DATOS DE RECEPCI&Oacute;N
        </td>
    </tr>
    <tr>
        <td style="width:20%" class="td">&nbsp;FECHA TRASLADO</td>
        <td style="width:10%;text-align:center;" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['FECHA_TRASLADO'];?></td>
        <td style="width:20%" class="td">&nbsp;HORA DE TRASLADO</td>
        <td style="width:60%" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['HORA_TRASLADO'];?></td>
    </tr>
    <tr>
        <td style="" class="td">&nbsp;FECHA DE RECEPCI&Oacute;N</td>
        <td style="text-align:center;" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['FECHA_RECEPCION'];?></td>
        <td style="" class="td">&nbsp;HORA DE RECEPCI&Oacute;N</td>
        <td style="" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['HORA_RECEPCION'];?></td>
    </tr>
    <tr>
        <td style="" class="td">&nbsp;DIFERENCIA</td>
        <td style="" class="td" colspan="3">&nbsp;<?php echo $num_dias;?> Dias, <?php echo $num_hora;?> horas y <?php echo $num_minutos;?> minutos</td>
    </tr>
</table>
    
    <br>

    <table style="width:100%;margin-bottom:20px" class="space border">
        <thead>
            <tr>
                <td style="width:8%;background-color:#9b9b9b;text-align:center;height:40px;">&nbsp;RUN PACIENTE</td>
                <td style="width:17%;background-color:#9b9b9b;height:40px;">&nbsp;NOMBRE DE PACIENTE</td>
                <td style="width:12%;background-color:#9b9b9b;height:40px;">&nbsp;FECHA DE TOMA DE MUESTRA</td>
                <td style="width:17%;background-color:#9b9b9b;height:40px;">&nbsp;TIPO DE MUESTRA</td> <!-- DES_SITIOEXT -->
                <td style="width:8%;background-color:#9b9b9b;text-align:center;height:40px;">N&deg; DE MUESTRA</td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td style="text-align:center;height:auto;" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['RUTPACIENTE'];?></td>
                <td style="" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['NOMBRE_COMPLETO'];?></td>
                <td style="" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['FECHA_SOLICITUD'];?></td>
                <td style="" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['DES_SITIOEXT'];?></td>
                <td style="text-align:center;" class="td"><?php echo $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['N_MUESTRAS'];?></td>
            </tr>
        </tbody>
    </table>
    ...
    <table style="width:100%" class="border">
        <thead>
            <tr>
                <td style="width:50%;background-color:#9b9b9b;height:40px;">&nbsp;NOMBRE DE FUNCIONARIO QUE ENTREGA LA MUESTRA</td>
                <td style="width:50%;background-color:#9b9b9b;height:40px;">&nbsp;NOMBRE DE FUNCIONARIA QUE RECIBE LA MUESTRA</td>
            </tr>
        </thead>
        <tbody>
            <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:80%;vertical-align:top;text-align:left;margin-left:15px;">
                                ...
                                <span style="font-size:13px;">
                                    <?php echo $cadenaModificada = str_replace("#", "<br>", $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['TXT_USER_TRASPORTE_FIRMA']);?>
                                </span>
                            </td> 
                        </tr>
                    </table>
                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td style="width:80%;vertical-align:top;text-align:left;margin-left:15px;">
                                ...
                                <br>    
                                <span style="font-size:13px;">
                                    <?php echo $cadenaModificada = str_replace("#", "<br>", $DATA['P_ANATOMIA_PATOLOGICA_MAIN'][0]['TXT_USER_RECPCIONA_FIRMA']);?>
                                </span>
                            </td> 
                        </tr>
                    </table>
