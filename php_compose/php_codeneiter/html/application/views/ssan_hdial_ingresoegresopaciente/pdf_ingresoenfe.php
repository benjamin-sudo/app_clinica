...
<table class="table four-columns">
    <thead>
        <tr>
            <th colspan="4">Información del Paciente</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td><b>NOMBRE:</b></td>
            <td colspan="3">[Nombre del Paciente]</td>
        </tr>
        <tr>
            <td><b>RUN:</b></td>
            <td colspan="3">[RUN del Paciente]</td>
        </tr>
        <tr>
...
<table>
    ...
    <tr>
        ...
        <td>[Detalle de los antecedentes quirúrgicos]</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Alimentos</td>
        <td>[Detalle de alergias a alimentos]</td>
    </tr>
    <tr>
        <td>Medicamentos</td>
        <td>[Detalle de alergias a medicamentos]</td>
    </tr>
    <tr>
        <td>Otros</td>
        <td>[Detalle de otras alergias]</td>
    </tr>
    <tr>
        <td>Diagnóstico de ingreso</td>
        <td>[Buscador CIE-10, SIN CIE-10 SELECCIONADOS]</td>
    </tr>
    <tr>
        <td>Establecimiento al que se deriva en caso de urgencia</td>
        <td>[Detalle del establecimiento]</td>
    </tr>
    <tr>
        <td>Grupo sanguíneo</td>
        <td>[Grupo sanguíneo seleccionado]</td>
    </tr>
    <tr>
        <td>Factor Sangre</td>
        <td>[Factor RH seleccionado]</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>P/A</td>
        <td>[Presión Diastólica / Presión Sistólica]</td>
    </tr>
    <tr>
        <td>Talla</td>
        <td>[Valor en CM]</td>
    ...
    <tr>
        <td>Movilidad</td>
        <td>[Descripción de la movilidad]</td>
    </tr>
    <tr>
        <td>Nutrición</td>
        <td>[Descripción de la nutrición]</td>
    </tr>
    <tr>
        <td>Grado de conciencia</td>
        <td>[Descripción del grado de conciencia]</td>
    </tr>
    <tr>
        <td>Estado de la piel</td>
        <td>[Descripción del estado de la piel]</td>
    </tr>
    <tr>
        <td>Conjuntivas</td>
        <td>[Descripción de las conjuntivas]</td>
    </tr>
    <!-- Añade más filas según sea necesario -->
</table>

<!-- Sección de Acceso Vascular -->
...
<table>
    ...
    <tr>
        <td>FAV</td>
        <td>[Descripción del FAV]</td>
        <td>[Fecha]</td>
    </tr>
    <tr>
        <td>Gorotex</td>
        <td>[Descripción de Gorotex]</td>
        <td>[Fecha]</td>
    </tr>
    <tr>
        <td>Catéter</td>
        <td>[Descripción del catéter]</td>
        <td>[Fecha]</td>
    </tr>
    <!-- Añade más filas según sea necesario -->
</table>
...
<table>
    ...
    <tr>
        <td>HVC</td>
        <td>[Descripción del HVC]</td>
        <td>[Fecha]</td>
    </tr>
    <tr>
        <td>HIV</td>
        <td>[Descripción del HIV]</td>
        <td>[Fecha]</td>
    </tr>
    <tr>
        <td>HBSAG</td>
        <td>[Descripción del HBSAG]</td>
        <td>[Fecha]</td>
    </tr>
    <!-- Añade más filas según sea necesario -->
</table>
...
<!-- Sección de Antecedentes Hemodiálisis -->
<div class="featured-header">
    <b>3. ANTECEDENTES HEMODIÁLISIS</b>
</div>
<table>
    <tr>
        <th>Elemento</th>
    ...
    <tr>
        <td>Heparina I</td>
        <td>[Valor de heparina I]</td>
    </tr>
    <tr>
        <td>Heparina M</td>
        <td>[Valor de heparina M]</td>
    </tr>
    <tr>
        <td>1° Dosis HVB</td>
        <td>[Detalle de la 1° dosis HVB]</td>
    </tr>
    <tr>
        <td>QD</td>
        <td>[Valor de QD]</td>
    ...
    <tr>
        <td>Baño K+/Na</td>
        <td>[Detalle del baño K+/Na]</td>
    </tr>
    <tr>
        <td>2° Dosis HVB</td>
        <td>[Detalle de la 2° dosis HVB]</td>
    </tr>
    <tr>
        <td>Peso seco</td>
        <td>[Valor del peso seco]</td>
    </tr>
    <tr>
        <td>Concentrado</td>
        <td>[Detalle del concentrado]</td>
    </tr>
    <tr>
        <td>3° Dosis HVB</td>
        <td>[Detalle de la 3° dosis HVB]</td>
    </tr>
    <tr>
        <td>1° refuerzo HVB</td>
        <td>[Detalle del 1° refuerzo HVB]</td>
    </tr>
</table>
...
<div>
    <p>[Texto de las observaciones finales]</p>
</div>
