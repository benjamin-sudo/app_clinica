...
function selectM(ext,idPrin) {

    var variables = {"idPrin": idPrin, "ext": ext};
    var id = "carga";
    var funcion = "selectMen";
...
function resetearClaves() {
    ...
    var variables = {"funcion": 9, "correo": correo}
    var id = "m1";
    ajax(variables, id);
    $("#m4").show(500);
}
...
function CambioPass() {
    ...
    if (txtPassNueva == '' || txtRePassNueva == '') {
        ...
        var id = "guardaUsuu";
        var variables = {"txtPassNueva": txtPassNueva, "txtRePassNueva": txtRePassNueva}
        ajax(variables, id, funcion);
    }
}
