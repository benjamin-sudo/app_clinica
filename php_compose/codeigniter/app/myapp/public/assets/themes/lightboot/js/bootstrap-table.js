            ...
            $.each(columns, function (j, column) {
                ...
                if (column.checkbox) {
                    if (!that.options.singleSelect && that.options.checkboxHeader) {
                        text = '<input id="btSelectAll" name="btSelectAll" type="checkbox" /><label for="btSelectAll"><span></span></label>';
                    }
            ...
            $.each(this.columns, function (i, column) {
                ...
                if (column.switchable) {
                    html.push(sprintf('<li>' +
                        '<input id="%s" type="checkbox" data-field="%s" value="%s"%s><label for="%s"><span></span> %s</label>' +
