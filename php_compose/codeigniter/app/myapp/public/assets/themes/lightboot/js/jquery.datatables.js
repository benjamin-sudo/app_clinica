...
(function (c) {
    ...
    c.extend(j.prototype, {_constructor: function () {
            ...
            return c.map(this.s.columns, function (e, c) {
                if (!e.never && !e.control)
                    return{title: d.settings()[0].aoColumns[c].sTitle, data: d.cell(a, c).render(b.c.orthogonal), hidden: d.column(c).visible() && !b.s.current[c], columnIndex: c, rowIndex: a}
            })
        }, _find: function (a) {
    ...
    j.display = {childRow: function (a, b, d) {
            if (b) {
    ...
    j.renderer = {listHidden: function () {
            return function (a,
                    b, d) {
