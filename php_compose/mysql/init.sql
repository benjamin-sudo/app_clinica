...
INSERT INTO `GU_TPERMISOS` (`PER_ID`, `PER_NOMBRE`, `PER_ESTADO`) VALUES
(1,	'ADMIN',	1),
...
/*
Relación del permiso ADMIN con todos los menús
*/

INSERT INTO ADMIN.GU_TMENPTIENEPER (PER_ID, MENP_ID, IND_ESTADO) VALUES
(1, 1, 1), -- BDU PACIENTES
(1, 2, 1), -- MAESTRO DE PACIENTES
(1, 3, 1), -- GESTOR UNICO PACIENTES
(1, 4, 1), -- PRESTADORES
(1, 5, 1), -- GESTIÓN DE PRESTADORES
(1, 6, 1), -- AGREGA EDITA PRESTADOR
(1, 7, 1), -- DIALISIS
(1, 8, 1), -- PACIENTE DE DIALISIS
(1, 9, 1), -- HOJA DE TRATAMIENTO
(1, 10, 1), -- INGRESO EGRESO PACIENTE
(1, 11, 1), -- HOJA DE TRATAMIENTO ENFE
(1, 12, 1), -- HOJA DE TRATAMIENTO DOC
(1, 13, 1), -- ELIMINAR HOJA DE TRATAMIENTO
(1, 14, 1), -- ANATOMIA PATOLOGICA
(1, 15, 1), -- NUEVA SOLICITUD DE ANATOMIA
(1, 16, 1), -- SOLICITUD ANATOMIA
(1, 18, 1), -- RECEPCION DE SOLICITUDES
(1, 19, 1), -- GESTION DE RECEPCIÓN
(1, 20, 1), -- PUNTO DE TOMA DE MUESTRA
(1, 21, 1), -- TOMA DE MUESTRA ADMIN
(1, 22, 1), -- TOMA DE MUESTRA USUARIOS
(1, 23, 1), -- PROCESAMIENTO ANATOMIA
(1, 24, 1), -- 1.- SALA MACROSCOPICA
(1, 25, 1), -- 2.- SALA PROCESO
(1, 26, 1), -- 3.- SALA INCLUSIÓN
(1, 27, 1), -- 4.- RCE PATÓLOGO
(1, 28, 1), -- GESTION ADMINISTRATIVO
(1, 29, 1), -- EDICION INFORMACION BIOPSIA
(1, 30, 1), -- NOTIFICACION DE CANCER
(1, 31, 1), -- LISTADO DE CANCER
(1, 32, 1); -- PERSONAL ADMINISTRATIVO

/*
Relación del permiso SISTEMA->BDU->MAESTROPACIENTES
*/

INSERT INTO ADMIN.GU_TMENPTIENEPER (PER_ID, MENP_ID, IND_ESTADO) VALUES
(2, 2, 1), -- MAESTRO DE PACIENTES
(2, 3, 1); -- GESTOR UNICO PACIENTES

/*
Relación del permiso ROL->ANATOMIA->ADMIN
*/

INSERT INTO ADMIN.GU_TMENPTIENEPER (PER_ID, MENP_ID, IND_ESTADO) VALUES
(3, 14, 1), -- ANATOMIA PATOLOGICA
(3, 15, 1), -- NUEVA SOLICITUD DE ANATOMIA
(3, 16, 1), -- SOLICITUD ANATOMIA
(3, 18, 1), -- RECEPCION DE SOLICITUDES
(3, 19, 1), -- GESTION DE RECEPCIÓN
(3, 20, 1), -- PUNTO DE TOMA DE MUESTRA
(3, 21, 1), -- TOMA DE MUESTRA ADMIN
(3, 22, 1), -- TOMA DE MUESTRA USUARIOS
(3, 23, 1), -- PROCESAMIENTO ANATOMIA
(3, 24, 1), -- 1.- SALA MACROSCOPICA
(3, 25, 1), -- 2.- SALA PROCESO
(3, 26, 1), -- 3.- SALA INCLUSIÓN
(3, 27, 1), -- 4.- RCE PATÓLOGO
(3, 28, 1), -- GESTION ADMINISTRATIVO
(3, 29, 1), -- EDICION INFORMACION BIOPSIA
(3, 30, 1), -- NOTIFICACION DE CANCER
(3, 31, 1), -- LISTADO DE CANCER
(3, 32, 1); -- PERSONAL ADMINISTRATIVO

/*
Relación del permiso ROL->DIALISIS->ADMIN
*/

INSERT INTO ADMIN.GU_TMENPTIENEPER (PER_ID, MENP_ID, IND_ESTADO) VALUES
(4, 7, 1), -- DIALISIS
(4, 8, 1), -- PACIENTE DE DIALISIS
(4, 9, 1), -- HOJA DE TRATAMIENTO
(4, 10, 1), -- INGRESO EGRESO PACIENTE
(4, 11, 1), -- HOJA DE TRATAMIENTO ENFE
(4, 12, 1), -- HOJA DE TRATAMIENTO DOC
(4, 13, 1); -- ELIMINAR HOJA DE TRATAMIENTO

/*
Relación del permiso ROL->PRESTADORES->ADMIN
*/

INSERT INTO ADMIN.GU_TMENPTIENEPER (PER_ID, MENP_ID, IND_ESTADO) VALUES
(5, 4, 1), -- PRESTADORES
(5, 5, 1), -- GESTIÓN DE PRESTADORES
(5, 6, 1); -- AGREGA EDITA PRESTADOR
