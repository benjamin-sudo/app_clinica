...
class Ssan_libro_biopsias_listaexterno1 extends CI_Controller {
    ...
    public function index(){
        ...
        $return_data = $this->Ssan_libro_biopsias_usuarioext_model->model_busquedasolicitudes_rotulo([
    ...
    public function update_main(){
        ...
        #DATE INICIO TIEMPO
        /*
        $this->input->set_cookie(array('name' => 'date_inicio', 'value' => $date_inicio, 'expire' => 86500, 'secure' => false ));
        #DATE INICIO TIEMPO
        $this->input->set_cookie(array('name' => 'date_final', 'value' => $date_final, 'expire' => 86500, 'secure' => false ));
        */
        #SALIDA ARREGLO
        $aData = $this->Ssan_libro_biopsias_usuarioext_model->model_busquedasolicitudes_rotulo(array(
    ...
    public function update_main_recepcion(){
        if(!$this->input->is_ajax_request()){ show_404(); }
        $session = explode("-",$this->session->userdata("USERNAME"));
        $date_inicio = $this->input->post('fecha_inicio');
        $date_final = $this->input->post('fecha_final');
        ...
        #$this->input->set_cookie(array('name' => 'date_final', 'value' => $date_final, 'expire' => 86500, 'secure' => false ));
        #SALIDA ARREGLO
        $aData = $this->Ssan_libro_biopsias_usuarioext_model->model_busquedasolicitudes_recepcion(array(
            "data_inicio" => $date_inicio,
            "data_final" => $date_final,
            "usr_session" => $session[0],
            "ind_opcion" => $this->input->post('OPTION'),
