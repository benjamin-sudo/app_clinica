...
<html>
<head>
    <title>Ingreso hermodialisis</title>
    <style>
        body {
        ...
        th {
            ...
            color: #333;
            font-size: 14px;
            border-top: 0px solid #dddddd; /* Específicamente reafirmar que no hay borde superior para los encabezados tambien */
        }
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <?php
                    if(count($cie_10)>0){
                        foreach ($cie_10 as $i => $row) {
                            echo '<b>'.$row['CODIGO_DG_BASE'].'</b> - '.$row['DESCRIPCION'].'<br>';
                        }
                    } 
                ?>
            </td>
